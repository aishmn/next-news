	...
	return (
		<nav className="navbar navbar-light ">
			<ul className="nav text-light">
				<span className="btn" onClick={(e) => setShowDrawer(!showDrawer)} type="button">
					<i className="fa fa-arrow-circle-left fa-2x ml-1 text-primary" aria-hidden="true"></i>
				</span>
				<h5 className="navbar-brand font-weight-bold self-align-center navlink">ADMINISTRATION</h5>
